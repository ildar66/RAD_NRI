...
public class PeopleEJBBeanFunctionSet_6bbce083 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	...
	public void Create(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		try {
			...
			// For column PASSPORTDATE
			{
				...
				if(tempDate != null)
					pstmt.setTimestamp(6,new java.sql.Timestamp(tempDate.getTime()));
				else
	...
	public javax.resource.cci.Record FindByPrimaryKey(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		try {
			pstmt = prepareStatement(connection,"SELECT T1.FIRSTNAME, T1.LASTNAME, T1.MIDDLENAME, T1.PASSPORTSER, T1.PASSPORTDATE, T1.PASSPORTWHOM, T1.ISACTIVE, T1.TABNUM, T1.MAN FROM INFORMIX.PEOPLE  T1 WHERE T1.MAN = ?");
	...
	public javax.resource.cci.Record FindByPrimaryKeyForUpdate(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		ResultSet result=null;
		try {
			pstmt = prepareStatement(connection,"SELECT T1.FIRSTNAME, T1.LASTNAME, T1.MIDDLENAME, T1.PASSPORTSER, T1.PASSPORTDATE, T1.PASSPORTWHOM, T1.ISACTIVE, T1.TABNUM, T1.MAN FROM INFORMIX.PEOPLE  T1 WHERE T1.MAN = ? FOR UPDATE ");
