...
public class OperatorEJBBeanAdaptorBinding_f75441b3 implements com.ibm.ws.ejbpersistence.beanextensions.BeanAdaptorBinding {
	...
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.nri.ejb.websphere_deploy.ORACLE_V9_1.OperatorEJBBeanExtractor_f75441b3
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.nri.ejb.websphere_deploy.ORACLE_V9_1.OperatorEJBBeanExtractor_f75441b3();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.nri.ejb.websphere_deploy.ORACLE_V9_1.OperatorEJBBeanInjectorImpl_f75441b3();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("OperatorEJB", "OperatorEJB1_Alias", "ORACLE", "INFORMIX.OPERATORS", "OperatorEJB_OperatorEJB1_Table");

		//-------------------------------------------------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[6];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("MAN", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._DECIMAL, -1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 10, 0, 0);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("PASSWORD", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 160, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("ISENABLED", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("MSUCODE", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._DECIMAL, -1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 10, 0, 0);
		fields[4] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("LOIGINID", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 160, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[5] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("OPERATOR_", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._DECIMAL, -1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 10, 0, 0);
		primarykey = new String[1];
		primarykey[0] = "OPERATOR_";
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("password", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("isEnabled", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols.BOOLEAN, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("msuCode", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._INTEGER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[4] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("loginID", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[5] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("operator", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._INTEGER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		primarykey = new String[1];
		...
		"select t1.MAN,t1.PASSWORD,_converter(\"com.ibm.vap.converters.VapStringToBooleanConverter\",t1.ISENABLED),t1.MSUCODE,t1.LOIGINID,t1.OPERATOR_ from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.nri.ejb.websphere_deploy.ORACLE_V9_1.OperatorEJBBeanFunctionSet_f75441b3");
