...
public class WorkPositionEJBBeanAdaptorBinding_7199c149 implements com.ibm.ws.ejbpersistence.beanextensions.BeanAdaptorBinding {
	...
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.nri.ejb.websphere_deploy.ORACLE_V9_1.WorkPositionEJBBeanExtractor_7199c149
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.nri.ejb.websphere_deploy.ORACLE_V9_1.WorkPositionEJBBeanExtractor_7199c149();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.nri.ejb.websphere_deploy.ORACLE_V9_1.WorkPositionEJBBeanInjectorImpl_7199c149();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("WorkPositionEJB", "WorkPositionEJB1_Alias", "ORACLE", "INFORMIX.WORKPOSITIONS", "WorkPositionEJB_WorkPositionEJB1_Table");

		//-------------------------------------------------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[3];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("NAME", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 800, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("ISACTIVE", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("WORKPOSITION", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._DECIMAL, -1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 10, 0, 0);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("isActive", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols.BOOLEAN, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		...
		"select t1.NAME,_converter(\"com.ibm.vap.converters.VapStringToBooleanConverter\",t1.ISACTIVE),t1.WORKPOSITION from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.nri.ejb.websphere_deploy.ORACLE_V9_1.WorkPositionEJBBeanFunctionSet_7199c149");
