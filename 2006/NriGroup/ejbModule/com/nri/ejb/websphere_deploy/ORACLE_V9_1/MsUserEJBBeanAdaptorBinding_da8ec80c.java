...
public class MsUserEJBBeanAdaptorBinding_da8ec80c implements com.ibm.ws.ejbpersistence.beanextensions.BeanAdaptorBinding {
	...
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.nri.ejb.websphere_deploy.ORACLE_V9_1.MsUserEJBBeanExtractor_da8ec80c
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.nri.ejb.websphere_deploy.ORACLE_V9_1.MsUserEJBBeanExtractor_da8ec80c();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.nri.ejb.websphere_deploy.ORACLE_V9_1.MsUserEJBBeanInjectorImpl_da8ec80c();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("MsUserEJB", "MsUserEJB1_Alias", "ORACLE", "INFORMIX.MSUSERS", "MsUserEJB_MsUserEJB1_Table");

		//-------------------------------------------------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[3];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("MSUCODE", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._DECIMAL, -1, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 10, 0, 0);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("MSUSER", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 80, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		...
		"select t1.MSUCODE,t1.MSUSER,t1.MSPASSWORD from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.nri.ejb.websphere_deploy.ORACLE_V9_1.MsUserEJBBeanFunctionSet_da8ec80c");
