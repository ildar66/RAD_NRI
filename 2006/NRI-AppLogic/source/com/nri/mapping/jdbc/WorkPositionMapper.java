...
public class WorkPositionMapper extends JDBCMapper implements com.nri.mapping.WorkPositionMapper {
	protected static final String findByNameSqlString = "SELECT first 1000 workPosition, name, isActive FROM " + ApplProperties.getDatasourceSchema() + ".workPositions WHERE LOWER(name) matches LOWER(?)";
